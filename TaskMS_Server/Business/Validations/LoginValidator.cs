...
public class LoginValidator : AbstractValidator<LoginDto>
{
    ...
    {
        RuleFor(p => p.UserNameOrEmail).NotEmpty().WithMessage("Geçerli bir kullanıcı adı ya da email adresi giriniz.");
        RuleFor(p => p.UserNameOrEmail).MinimumLength(3).WithMessage("Geçerli bir kullanıcı adı ya da email adresi giriniz.");
